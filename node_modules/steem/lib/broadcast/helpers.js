...
exports = module.exports = function (steemBroadcast) {
  ...
  steemBroadcast.addKeyAuth = function (activeWif, username, authorizedKey) {
    var role = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'posting';
    var weight = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
    var cb = arguments[5];

    _api2.default.getAccountsAsync([username]).then(function (_ref5) {
  ...
  steemBroadcast.removeKeyAuth = function (activeWif, username, authorizedKey) {
    var role = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'posting';
    var cb = arguments[4];

    _api2.default.getAccountsAsync([username]).then(function (_ref7) {
